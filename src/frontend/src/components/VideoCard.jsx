...
export default function VideoCard({ video, showEditButton = false, onEdit, onDelete }) {
  ...
  return (
    <div className={`video-card${isProcessing ? ' video-card--processing' : ''}`} onClick={handleClick}>
      ...
      <div className="video-card-thumb">
        ...
        {isProcessing && (
          <span className="video-card-processing-badge">Обрабатывается…</span>
        )}
        ...
        {showEditButton && (
          <div className="video-card-actions" onClick={e => e.stopPropagation()}>
            ...
            <button className="video-card-delete" onClick={handleDelete} title="Удалить">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" strokeWidth="2"
                strokeLinecap="round" strokeLinejoin="round">
